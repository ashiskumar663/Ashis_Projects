...
public class FileOperations {
	...
	public static void main(String[] args) {
		//Create a file
		 File file = new File("C:\\Users\\samal\\eclipse-workspace.txt");
		  try 
		  {  
		   ...
		   String data = "This is the data in the output file";
		    ...
		    try {
		      ...
		      FileWriter output = new FileWriter("C:\\Users\\samal\\eclipse-workspace.txt");
		    ...
		    try {
		      ...
		      FileReader input = new FileReader("C:\\Users\\samal\\eclipse-workspace.txt");
